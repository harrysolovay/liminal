import { Completion, Context, Exec } from "liminal"
  ...
  return Context(
    ...
    function* () {
      ...
      yield `Text:
        ...
        ${text}
      `
      let currentTranslation = yield* Completion()
      let iterations = 0
      ...
      while (iterations < MAX_ITERATIONS) {
        yield `
          ...
          4. Cultural accuracy
        `
        const evaluation = yield* Completion(
          type({
        ...
        `
        const improvedTranslation = yield* Completion()
